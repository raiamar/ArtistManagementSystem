...
if (!hasRole('super_admin'))
    redirect('?page=' . match (currenctUser()['role']) {
...
$totalArtists = (int) Database::fetchOne("SELECT COUNT(*) as count FROM artists")['count'];
$totalMusics  = (int) Database::fetchOne("SELECT COUNT(*) as count FROM musics")['count'];
$totalManagers = (int) Database::fetchOne("SELECT COUNT(*) as count FROM users WHERE role = 'artist_manager' AND isActive = TRUE")['count'];
?>
